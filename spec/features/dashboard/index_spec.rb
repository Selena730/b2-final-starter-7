...
RSpec.describe "merchant dashboard" do
  before :each do
    ...
    @bulk_discount1 = BulkDiscount.create!(percentage_discount: 10, quantity_threshold: 10, merchant: @merchant1)
    @bulk_discount2 = BulkDiscount.create!(percentage_discount: 20, quantity_threshold: 20, merchant: @merchant1)
  ...
  # User Story 1
  it "views all discounts and their percentage and quantity thresholds" do 
    ...
    expect(page).to have_content("#{@bulk_discount1.percentage_discount}% off #{@bulk_discount1.quantity_threshold} items")
  end
end
